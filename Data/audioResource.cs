...
{
    public static string selection_switch = "Sound/[00]Components/Buttons/[Button Possitive][bubaproducer]button-5";
    public static string selection_negative = "Sound/[00]Components/Buttons/[Button Negative][bubaproducer]button-4";
    public static string select_small = "Sound/[00]Components/Buttons/[Typer Negative][potentjello]buttons-and-knobs-10";
    public static string page_turn = "Sound/[00]Components/Buttons/[Page][mydo1]page-turn";
    public static string electrical = "Sound/[00]Components/Buttons/[Electric][littlerobotsoundfactory]click-electronic-14";
    public static string electrical_out = "Sound/[00]Components/Buttons/[Electric Out][kickhat]button-sound-closed-1";
