...
public class diaryLog
{
    ...
    {
        string killer = ODMVariable.text.none;
    ...
    {
        string mate = ODMVariable.text.none;
        if (resist.Count > 0)
        {
    ...
    {
        string get_climax_mate = ODMVariable.text.none;
    ...
    {
        string best_feed_mate = ODMVariable.text.none;
        if (feed.Count > 0)
        {
    ...
    {
        string best_feed_success_mate = ODMVariable.text.none;
    ...
    {
        string best_feed_failure_mate = ODMVariable.text.none;
